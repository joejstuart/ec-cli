...
func TestEvaluatorLifecycle(t *testing.T) {
	...
	validate := func(_ context.Context, component app.SnapshotComponent, _ *app.SnapshotSpec, _ policy.Policy, evaluators map[string]evaluator.Evaluator, _ bool) (*output.Output, error) {
