...
require (
	...
	github.com/enterprise-contract/enterprise-contract-controller/api v0.1.115
	...
	github.com/testcontainers/testcontainers-go v0.37.0 // using unreleased version that contains the fix in https://github.com/testcontainers/testcontainers-go/pull/2899
